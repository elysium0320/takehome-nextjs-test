...
This project was originally bootstrapped using NPM package manager. So you can use NPM to install dependencies.
But I recommend using Yarn package manager to install dependencies and run this project. Even though you can install dependencies using NPM, you must use Yarn to run this project correctly because it uses Yarn to run husky and lint-staged. (This project uses husky and lint-staged to lint and prettifies code base before commit)
...
PS: recommend to use vscode for IDE
